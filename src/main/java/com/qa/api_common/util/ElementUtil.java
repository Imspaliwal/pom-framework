 ...
 *
 */
package com.qa.api_common.util;
...
public class ElementUtil {
    ...
    public void doSendKeys(By locator, String value) {
        ...
        // ele.clear();
        // JLog.write("Cleared the WebElement: " +
        // StringUtil.convertByToString(locator));
        ele.sendKeys(value);
    ...
    public void doSendKeys(WebElement locator, String value) {
        ...
        // locator.clear();
        // JLog.write("Cleared the WebElement: " +
        // StringUtil.convertWebElementToString(locator));
    ...
    public String getFirstSelectedOption(By selectLocator) {
        ...
        JLog.info("First Selected Option : " + StringUtil.convertWebElementToString(firstSelectedOptions)
                + " has text: " + text);
    ...
    public boolean select(String fieldLabel, By dropDown, By options, String valueToSearch, String valueToSelect)
        ...
        JLog.info(String.format("Search " + valueToSearch + " and Select Drown Down %s item: %s", fieldLabel,
                valueToSelect));
    ...
    public boolean select(String fieldLabel, WebElement dropDown, WebElement options, String valueToSelect)
        ...
        // .format("//div[@role='option'][normalize-space()='%s']",
        // valueToSelect)))
        // .click();
