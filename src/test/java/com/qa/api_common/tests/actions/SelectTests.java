...
import com.qa.api_common.base.BaseTest;
...
public class SelectTests extends BaseTest {
    ...
    public void dynamicDropDownTest_01() {
        ...
        By dropDownLocator = By.xpath(
                "//label[contains(@class, 'label') and normalize-space()='User Role']/../following-sibling::div//div[contains(@class, 'select-text-input')]");
